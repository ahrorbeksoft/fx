...
Set `FX_JEV_GATEWAY_API_KEY` to a dedicated AI Gateway key for Jev routing and
compaction evaluations. Normal model inference continues using its configured
